...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_NAME = "weather888.db";
    ...
    public void deleteData(String date_time, String location){
        ...
        db.delete(TABLE_NAME,
                COLUMN_DATE_TIME + "='" + date_time + "' AND " + COLUMN_LOCATION + "='" + location + "'",
                null);
        db.close();
    ...
    public WeatherData[] read_all_data_loc(String location){
        SQLiteDatabase db = getReadableDatabase();
        Cursor cursor = db.query(TABLE_NAME, null, COLUMN_LOCATION + "=?",
                new String[] {location}, null, null, null);
